# Get Global Settings | FluentCart Developer Docs

URL: https://dev.fluentcart.com/restapi/operations/integration/get-global-settings.html
...
GET /integration/global-settings Retrieve global settings for integrations.
...
Content-Type application/json Schema JSON JSON { "settings" : [ { } ] , "settings_key" : "" , "message" : "Sorry! No integration failed found with: " } GET /integration/global-settings 
## Playground​
