# List Coupons | FluentCart Developer Docs

URL: https://dev.fluentcart.com/restapi/operations/coupons/list-coupons.html
...
GET /coupons Retrieve a paginated list of coupons with optional filtering and searching.
