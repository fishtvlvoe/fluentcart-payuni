# Get License Pie Chart | FluentCart Developer Docs

URL: https://dev.fluentcart.com/restapi/operations/licensing/get-license-pie-chart.html
...
GET /reports/license-pie-chart Retrieve license data formatted for a pie chart visualization.
...
Content-Type application/json Schema JSON JSON { } GET /reports/license-pie-chart 
## Playground​
...
```
curl 'https://{website}/wp-json/fluent-cart/v2/reports/license-pie-chart?params%5BstartDate%5D=2024-01-01&params%5BendDate%5D=2024-12-31' \
  --header 'Authorization: Authorization'
```

JavaScript 
```
fetch('https://{website}/wp-json/fluent-cart/v2/reports/license-pie-chart?params%5BstartDate%5D=2024-01-01&params%5BendDate%5D=2024-12-31', {
  headers: {
...
PHP 
```
$ch = curl_init("https://{website}/wp-json/fluent-cart/v2/reports/license-pie-chart?params%5BstartDate%5D=2024-01-01&params%5BendDate%5D=2024-12-31");
...
```
requests.get(
    "https://{website}/wp-json/fluent-cart/v2/reports/license-pie-chart",
    headers={
      "Authorization": "Authorization"
    },
    params={
