...
5. Run unit tests: `cd /Users/fishtv/Development/fluentcart-payuni && composer test -- --filter OrderPayUNiMetaBox`
  </verify>
  <done>
...
4. Manual verification in FluentCart admin shows PayUNi data panel
5. All payment types (credit/ATM/CVS) display correct info in UI
6. Non-PayUNi orders pass through unchanged (no panel shown)
</verification>
