...
define('BUYGO_FC_PAYUNI_VERSION', '1.1.2');
...
/**
 * 初始化自動更新器（在 admin 環境下，不依賴 FluentCart）
 * 必須在 plugins_loaded 之前註冊，以確保更新檢查能正常運作
 */
if (is_admin()) {
    require_once BUYGO_FC_PAYUNI_PATH . 'includes/class-updater.php';
